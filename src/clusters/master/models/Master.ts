import { CURRENT_DATETIME, DELAY, LOGGER } from '../../..//configs/configs'
...
export default class Master {
  ...
  createWorkerInstance(): boolean {

    const currentWorkerNumber = this.workersToCreate + this.readyWorkers + 1
    LOGGER(`Criando novo worker: [${currentWorkerNumber}]`, { from: 'MASTER', pid: true })
